    ...
    <Card style={cardStyle}>
      ...
      <Form className="mt-2">
        ...
        <Form.Group style={inputStyle} controlId="formBasicPassword">
          <Form.Control style={inputContent} id='login-input' type={showPassword ? "text" : "password"} placeholder="Senha" />
          <i style={{backgroundColor: 'transparent', cursor: 'pointer', padding: '2%'}} onClick={toggleShowPassword} id="login-eye" className={`fa-regular ${showPassword ? "fa-eye-slash" : "fa-eye"}`}></i>
        </Form.Group>
